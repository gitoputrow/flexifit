                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              CachedNetworkImage(
                                imageUrl: controller.userPost!.profilepicture!,
                              ...
                              controller.userPost!.id!
                                          .substring(controller.userPost!.id!.indexOf("|") + 1) ==
                                      controller.userid
                                  ? InkWell(
                                      onTap: () async => await controller.deletePost,
                                      child: Icon(
                                        Icons.delete,
                                        size: 30,
                                  ...
                                  Obx(
                                    () {
                                      ...
                                      return InkWell(
                                        ...
                                        child: Icon(
                                          Icons.favorite,
                                          color: controller.userPost!.liked == true
                          ...
                          Align(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text: "' ${controller.userPost!.caption} '",
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: Colors.white,
                            ...
                            : Padding(
                                ...
                                child: ListView.separated(
                                    ...
                                    itemBuilder: (context, index) => CommentPostCard(
                                        commentPost: controller.commentPost[index],
                                        onDelete: () async => await controller.deleteComment(
                                            controller.commentPost[index].id!, context),
                                        buttonDelete: controller.commentPost[index].id!.substring(
                                                    controller.commentPost[index].id!.indexOf("|") +
                                                        1) ==
                                                controller.userid ||
                                            controller.userPost!.id!.substring(
                                                    controller.userPost!.id!.indexOf("|") + 1) ==
