...
import 'package:pain/feature/challenge/view/widgets/ChallangeCard.dart';
...
class ChallangePage extends GetView<WorkoutChallengeController> {
    ...
    return SafeArea(
      ...
      Expanded(
        child: LiquidPullToRefresh(
          ...
          height: 140,
          onRefresh: () async => await controller.getChallengeData(),
              ...
              itemBuilder: (context, index) => GestureDetector(
                    onTap: () async {
                      ...
                      Get.toNamed("/challangelevel", arguments: {
                        ...
                        'id': controller.challangeData[index].id,
                      });
                    },
