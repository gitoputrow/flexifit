...
import 'package:pain/Page/MainPage/SosmedPage/AddPostPage.dart';
...
import 'Page/MainPage/SosmedPage/DetailPostPage.dart';
...
class appRoutes {
  static final pages = <GetPage>[
    ...
    GetPage(name: "/login", page: () => LoginPage(), binding: AuthentificationBinding()),
    GetPage(name: "/regist", page: () => RegisterPage(), binding: AuthentificationBinding()),
    GetPage(name: "/dashboard", page: () => DashboardPage(), binding: DashboardBinding()),
    GetPage(name: "/challangelevel", page: () => ChallangeLevelPage(), binding: WorkoutBinding()),
    GetPage(name: "/workoutlist", page: () => WorkoutListPage(), binding: WorkoutBinding()),
    GetPage(name: "/workoutstart", page: () => WorkoutStartPage(), binding: WorkoutBinding()),
    GetPage(name: "/workoutrest", page: () => WorkoutRestPage(), binding: WorkoutBinding()),
    GetPage(name: "/workoutfinish", page: () => WorkoutFinishPage(), binding: WorkoutBinding()),
    GetPage(name: "/workoutprepare", page: () => WorkoutPreparePage(), binding: WorkoutBinding()),
    GetPage(name: "/settingpage", page: () => SettingPage(), binding: SettingBinding()),
    GetPage(name: "/editprofilepage", page: () => EditProfilePage(), binding: SettingBinding()),
    GetPage(name: "/editpasswordpage", page: () => EditPasswordPage(), binding: SettingBinding()),
    GetPage(name: "/addpostpage", page: () => AddPostPage(), binding: SosialMediaBinding()),
    GetPage(name: "/detailpostpage", page: () => DetailPostPage(), binding: SosialMediaBinding()),
    GetPage(name: "/profilepostpage", page: () => ProfilePostPage(), binding: SosialMediaBinding()),
  ];
}
