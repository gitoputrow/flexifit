...
class DashboardController extends GetxController {
  ...
  // set challangeIndex(int challangeIndex) =>
  //     _challangeIndex.value = challangeIndex;
  ...
  // set userPhotoLength(int userPhotoLength) =>
  //     _userPhotoLength.value = userPhotoLength;
  ...
  //       programWO
  //           .add(ProgramWO.fromJson(json.decode(json.encode(element.value))));
  //     });
  //     programWO.sort((a, b) =>
  ...
  //     data.children.forEach((element) {
  //       challangeData
  //           .add(Challange.fromJson(json.decode(json.encode(element.value))));
  //       loading = true;
  //     });
  //   } catch (e) {
  //     print(e);
  ...
  //     for (int index = 0;
  //         index < challangeData[challangeIndex].level!.length;
  //         index++) {
  //       final data = await database
  //           .child("userDatabase")
  //           .child("$userid")
  ...
  //           userPostData.add(
  //               UserPost.fromJson(json.decode(json.encode(element.value))));
  //         });
  //       });
